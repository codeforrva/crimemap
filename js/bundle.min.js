...
"use strict";var MapInfoWindow=require("./MapInfoWindow"),Logging=require("../mixins/Logging"),Map=React.createClass({displayName:"Map",mixins:[Logging],getInitialState:function(){return{markerGenTime:this.props.incidentFetchTime,heatmapGenTime:this.props.incidentFetchTime}},componentDidMount:function(){var e={center:{lat:37.5333,lng:-77.4667},zoom:12};this.setState({map:new google.maps.Map(this.getDOMNode(),e),infoWindow:new google.maps.InfoWindow})},componentWillReceiveProps:function(e){if(this.shouldGenMarkers(e)){this.log("Generating new markers"),this.setMarkerMap(null);var t=e.incidents.map(function(e){var t=new google.maps.Marker({position:new google.maps.LatLng(e.incident_location.latitude,e.incident_location.longitude),title:e.offense_code_desc,icon:getIcon(e.offense_code+e.offense_code_desc)});return google.maps.event.addListener(t,"click",function(){this.state.infoWindow.close(),this.state.infoWindow.setContent(React.renderToStaticMarkup(React.createElement(MapInfoWindow,{incident:e}))),this.state.infoWindow.open(this.state.map,t)}.bind(this)),t}.bind(this));this.setState({markers:t,markerGenTime:e.incidentFetchTime})}else if(this.shouldGenHeatmap(e)){this.log("Generating new heatmap"),this.setHeatmapMap(null);var a=e.heatmapPoints.map(function(e){return{location:new google.maps.LatLng(e.incident_location.latitude,e.incident_location.longitude),weight:getWeight(e.offense_code)}}),n=new google.maps.visualization.HeatmapLayer({data:new google.maps.MVCArray(a),radius:30});this.setState({heatmapLayer:n,heatmapGenTime:e.incidentFetchTime})}},shouldComponentUpdate:function(e){return this.shouldGenMarkers(e)||this.shouldGenHeatmap(e)||this.props.viewType!=e.viewType},render:function(){return"markers"==this.props.viewType?(this.setMarkerMap(this.state.map),this.setHeatmapMap(null)):"heatmap"==this.props.viewType&&(this.setMarkerMap(null),this.setHeatmapMap(this.state.map)),React.createElement("div",{id:"map-canvas",className:"col-sm-9 col-sm-pull-3 col-xs-12"})},setMarkerMap:function(e){if(this.state&&this.state.markers)for(var t in this.state.markers)this.state.markers[t].setMap(e)},setHeatmapMap:function(e){this.state&&this.state.heatmapLayer&&this.state.heatmapLayer.setMap(e)},shouldGenMarkers:function(e){return"markers"==e.viewType&&!!e.incidents&&e.incidentFetchTime>this.state.markerGenTime},shouldGenHeatmap:function(e){return"heatmap"==e.viewType&&!!e.heatmapPoints&&e.incidentFetchTime>this.state.heatmapGenTime}}),getIcon=function(e){return{path:google.maps.SymbolPath.CIRCLE,scale:6,fillColor:getColorString(e),fillOpacity:.9,strokeColor:getColorString(e,!0),strokeOpacity:.6,strokeWeight:1}},getColorString=function(e,t){var a=hashCode(e),n=parseInt(e.substring(0,2)),i=3.1*n,s=Math.abs((a>>8)%50),o=Math.abs((a>>4)%50);return"hsl("+i+", "+(s+50)+"%, "+(o+(t?0:25))+"%)"},hashCode=function(e){for(var t=5381,a=0;a<e.length;a++){var n=e.charCodeAt(a);t=(t<<5)+t+n}return t},getWeight=function(e){switch(parseFloat(e)){case 9:case 100:case 11:return 10;case 120:case 13:case 36:return 8;case 200:case 220:case 520:return 6;case 23:case 240:case 290:case 35:case 40:return 4;case 90:return 2;default:return 1}};module.exports=Map;
...
"use strict";var IncidentDataStore=require("../IncidentDataStore"),OffenseCodeList=React.createClass({displayName:"OffenseCodeList",propTypes:{offenseCodes:React.PropTypes.array},render:function(){var e=this.props.offenseCodes&&this.props.offenseCodes.map(function(e){return React.createElement("tr",{key:e.offense_code+e.offense_code_desc},React.createElement("td",null,e.offense_code),React.createElement("td",null,e.offense_code_desc))});return e&&0!=e.length?React.createElement("table",{className:"table table-striped table-hover table-condensed small offense-codes"},React.createElement("tbody",null,e)):null}});module.exports=OffenseCodeList;
