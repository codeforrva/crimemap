...
"use strict";var Alert=require("./mixins/Alert"),Logging=require("./mixins/Logging"),IncidentDataStore=function(){var e=function(e){e.responseJSON?Alert.sendAlert('And lo! The ground shook and a fell voice uttered fearsome words of great import: "'+e.responseJSON.message+'"'):(Alert.sendAlert("Whoops! Looks like we broke the Internet. Sorry about that."),Logging.error(e))},n=function(n){$("#loading").show();return $.getJSON("https://brigades.opendatanetwork.com/resource/ush7-in5v.json?$$app_token=3sg2sPslVNC65HpUxDTSfRR4d&"+$.param(n)).fail(function(n){e(n)})},t={INCIDENT_BASIC_INFO:"incident_location,offense_code_desc,incident_date_time,disposition_code_desc",INCIDENT_LOCATION:"incident_location"},i=function(e){var i=e.startDate||"2015-01-01",o=e.endDate||"2015-01-31",r=e.fields||t.INCIDENT_BASIC_INFO,d=parseInt(e.limit)||1e3,a=$.Deferred();return n({$select:r,$where:"incident_date_time >= '"+i+"T00:00:00' and incident_date_time <= '"+o+"T23:59:59'",$limit:d}).done(function(e){var n=e.filter(function(e){return e.incident_location.latitude&&e.incident_location.longitude}).map(function(e){return e.incident_address=JSON.parse(e.incident_location.human_address).address,e});a.resolve(n)}),a.promise()},o=function(e){var n=$.Deferred();return e.fields=t.INCIDENT_LOCATION,e.limit=5e4,i(e).done(function(e){n.resolve(e.filter(function(e){return!("-77.43364758299998"==e.incident_location.longitude&&"37.54070234900007"==e.incident_location.latitude||"-77.44491629499998"==e.incident_location.longitude&&"37.546095328000035"==e.incident_location.latitude)}))}),n.promise()};return{queryIncidents:i,queryHeatmap:o,Fields:t}}();module.exports=IncidentDataStore;
...
"use strict";var ControlPanel=require("./ControlPanel"),Map=require("./Map"),AlertBox=require("./AlertBox"),IncidentDataStore=require("../IncidentDataStore"),Logging=require("../mixins/Logging"),App=React.createClass({displayName:"App",mixins:[Logging],getInitialState:function(){return{startDate:"2015-01-01",endDate:"2015-01-31",incidentFetchTime:new Date,viewType:"markers"}},dateRangeChanged:function(t){this.setState(t)},dateRangeUpdate:function(){$.when(IncidentDataStore.queryIncidents({startDate:this.state.startDate,endDate:this.state.endDate}),IncidentDataStore.queryHeatmap({startDate:this.state.startDate,endDate:this.state.endDate})).done(function(t,e){this.setState({incidents:t,heatmapPoints:e,incidentFetchTime:new Date})}.bind(this))},viewTypeChanged:function(t){this.setState({viewType:t})},render:function(){var t=void 0;return"markers"==this.state.viewType&&this.state.incidents?t=this.state.incidents.length:"heatmap"==this.state.viewType&&this.state.heatmapPoints&&(t=this.state.heatmapPoints.length),React.createElement("div",{id:"container",className:"container-fluid pull-right"},React.createElement(ControlPanel,{startDate:this.state.startDate,endDate:this.state.endDate,viewType:this.state.viewType,pointCount:t,onDateRangeChanged:this.dateRangeChanged,onDateRangeUpdate:this.dateRangeUpdate,onViewTypeChanged:this.viewTypeChanged}),React.createElement(Map,{viewType:this.state.viewType,incidents:this.state.incidents,heatmapPoints:this.state.heatmapPoints,incidentFetchTime:this.state.incidentFetchTime}),React.createElement(AlertBox,null))}});module.exports=App;



},{"../IncidentDataStore":1,"../mixins/Logging":10,"./AlertBox":2,"./ControlPanel":4,"./Map":6}],4:[function(require,module,exports){
"use strict";var ControlSection=require("./ControlSection"),ControlPanel=React.createClass({displayName:"ControlPanel",propTypes:{startDate:React.PropTypes.string.isRequired,endDate:React.PropTypes.string.isRequired,viewType:React.PropTypes.string.isRequired,pointCount:React.PropTypes.number,onDateRangeChanged:React.PropTypes.func,onDateRangeUpdate:React.PropTypes.func,onViewTypeChanged:React.PropTypes.func},dateRangeChanged:function(){this.props.onDateRangeChanged&&this.props.onDateRangeChanged({startDate:this.refs.startDate.getDOMNode().value,endDate:this.refs.endDate.getDOMNode().value})},dateRangeUpdate:function(){this.props.onDateRangeUpdate&&this.props.onDateRangeUpdate()},viewTypeChanged:function(e){this.props.onViewTypeChanged&&this.props.onViewTypeChanged(e)},render:function(){var e=void 0!==this.props.pointCount?this.props.pointCount+" points displayed. ":void 0;return React.createElement("div",{id:"sidebar",className:"col-sm-3 col-sm-push-9 hidden-xs"},React.createElement("h4",null,"Richmond Police Incident Data"),React.createElement("div",{className:"panel-group",id:"accordion",role:"tablist","aria-multiselectable":"true"},React.createElement(ControlSection,{id:"DateRange",title:"Date Range",expanded:!0},React.createElement("p",null,"Display incidents within this date range:"),React.createElement("form",null,React.createElement("div",{className:"form-group"},React.createElement("label",{htmlFor:"startDate"},"Start Date"),React.createElement("input",{id:"startDate",ref:"startDate",type:"date",value:this.props.startDate,className:"form-control",onChange:this.dateRangeChanged})),React.createElement("div",{className:"form-group"},React.createElement("label",{htmlFor:"endDate"},"End Date"),React.createElement("input",{id:"endDate",ref:"endDate",type:"date",value:this.props.endDate,className:"form-control",onChange:this.dateRangeChanged})),React.createElement("span",{id:"numMarkers"}),React.createElement("button",{type:"button",className:"btn pull-right btn-primary",onClick:this.dateRangeUpdate},"Update"))),React.createElement(ControlSection,{id:"ViewType",title:"View Type"},React.createElement("form",null,React.createElement("div",{className:"form-group"},React.createElement("label",null,React.createElement("input",{id:"showMarkers",type:"radio",name:"viewType",onChange:this.viewTypeChanged.bind(this,"markers"),checked:"markers"==this.props.viewType?"checked":""}),"  Markers")),React.createElement("div",{className:"form-group"},React.createElement("label",null,React.createElement("input",{id:"showHeatmap",type:"radio",name:"viewType",onChange:this.viewTypeChanged.bind(this,"heatmap"),checked:"heatmap"==this.props.viewType?"checked":""}),"  Heatmap")))),React.createElement(ControlSection,{id:"About",title:"About"},React.createElement("p",null,"This app shows police incidents in Richmond. It has events from January of 2004 through January of 2015."),React.createElement("p",null,"Information comes from the Richmond Police Department's public data portal. The location is accurate to the block number, not the exact address."),React.createElement("p",null,"This app was built by ",React.createElement("a",{href:"http://www.codeforrva.org/"},"Code for RVA"),", a brigade of ",React.createElement("a",{href:"http://www.codeforamerica.org/"},"Code for America"),"."),React.createElement("p",null,"Data is hosted by ",React.createElement("a",{href:"http://www.socrata.com/"},"Socrata")," on the ",React.createElement("a",{href:"https://brigades.opendatanetwork.com/TRANSPARENCY/Richmond-Police-Incident-Data/ush7-in5v"},"Open Data Network"),"."))),React.createElement("div",{className:"pull-right"},e))}});module.exports=ControlPanel;



},{"./ControlSection":5}],5:[function(require,module,exports){
"use strict";var ControlSection=React.createClass({displayName:"ControlSection",propTypes:{id:React.PropTypes.string.isRequired,title:React.PropTypes.string.isRequired,expanded:React.PropTypes.bool},render:function(){return React.createElement("div",{className:"panel panel-default"},React.createElement("div",{className:"panel-heading",role:"tab",id:"heading"+this.props.id},React.createElement("h4",{className:"panel-title"},React.createElement("a",{"data-toggle":"collapse","data-parent":"#accordion",href:"#collapse"+this.props.id,"aria-expanded":"true","aria-controls":"collapse"+this.props.id},this.props.title))),React.createElement("div",{id:"collapse"+this.props.id,className:"panel-collapse collapse "+(this.props.expanded?"in":"out"),role:"tabpanel","aria-labelledby":"heading"+this.props.id},React.createElement("div",{className:"panel-body"},this.props.children)))}});module.exports=ControlSection;



},{}],6:[function(require,module,exports){
"use strict";var MapInfoWindow=require("./MapInfoWindow"),Logging=require("../mixins/Logging"),Map=React.createClass({displayName:"Map",mixins:[Logging],getInitialState:function(){return{markerGenTime:this.props.incidentFetchTime,heatmapGenTime:this.props.incidentFetchTime}},componentDidMount:function(){var e={center:{lat:37.5333,lng:-77.4667},zoom:12};this.setState({map:new google.maps.Map(this.getDOMNode(),e),infoWindow:new google.maps.InfoWindow})},componentWillReceiveProps:function(e){if(this.shouldGenMarkers(e)){this.log("Generating new markers"),this.setMarkerMap(null);var t=e.incidents.map(function(e){var t=new google.maps.Marker({position:new google.maps.LatLng(e.incident_location.latitude,e.incident_location.longitude),title:e.offense_code_desc,icon:getIcon(e.offense_code_desc)});return google.maps.event.addListener(t,"click",function(){this.state.infoWindow.close(),this.state.infoWindow.setContent(React.renderToStaticMarkup(React.createElement(MapInfoWindow,{incident:e}))),this.state.infoWindow.open(this.state.map,t)}.bind(this)),t}.bind(this));this.setState({markers:t,markerGenTime:e.incidentFetchTime})}else if(this.shouldGenHeatmap(e)){this.log("Generating new heatmap"),this.setHeatmapMap(null);var a=e.heatmapPoints.map(function(e){return new google.maps.LatLng(e.incident_location.latitude,e.incident_location.longitude)}),i=new google.maps.visualization.HeatmapLayer({data:new google.maps.MVCArray(a),radius:15});this.setState({heatmapLayer:i,heatmapGenTime:e.incidentFetchTime})}},shouldComponentUpdate:function(e){return this.shouldGenMarkers(e)||this.shouldGenHeatmap(e)||this.props.viewType!=e.viewType},render:function(){return"markers"==this.props.viewType?(this.setMarkerMap(this.state.map),this.setHeatmapMap(null)):"heatmap"==this.props.viewType&&(this.setMarkerMap(null),this.setHeatmapMap(this.state.map)),React.createElement("div",{id:"map-canvas",className:"col-sm-9 col-sm-pull-3 col-xs-12"})},setMarkerMap:function(e){if(this.state&&this.state.markers)for(var t in this.state.markers)this.state.markers[t].setMap(e)},setHeatmapMap:function(e){this.state&&this.state.heatmapLayer&&this.state.heatmapLayer.setMap(e)},shouldGenMarkers:function(e){return"markers"==e.viewType&&!!e.incidents&&e.incidentFetchTime>this.state.markerGenTime},shouldGenHeatmap:function(e){return"heatmap"==e.viewType&&!!e.heatmapPoints&&e.incidentFetchTime>this.state.heatmapGenTime}}),getIcon=function(e){return{path:google.maps.SymbolPath.CIRCLE,scale:6,fillColor:getColorString(e),fillOpacity:.9,strokeColor:getColorString(e,!0),strokeOpacity:.6,strokeWeight:1}},getColorString=function(e,t){for(var a=5381,i=0;i<e.length;i++){var n=e.charCodeAt(i);a=(a<<5)+a+n}var s=a%360,o=Math.abs((a>>8)%50),r=Math.abs((a>>4)%50);return"hsl("+s+", "+(o+50)+"%, "+(r+(t?0:25))+"%)"};module.exports=Map;
